...
$sql = "SELECT * FROM product WHERE type = 'vishwas collection'";
...
<center>
    <h2 id="diamondring" class="txtshd"><i>VISHWAS PATIL</i></h2>
    <hr class="hr" style="border:2px solid silve; width: 280px;  border-bottom: white;">
</center>
...
<!-- Script to handle buying a product -->
<script>
    function buyProduct(productId, productName, productDescription, productPrice) {
        // Set product details in the order form
